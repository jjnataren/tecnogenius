...
<h2>
	Curso <strong><?php echo $model->NAME; ?></strong>, documentos.	
</h2>
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes'=>array(
		'ID',
		'HIERARCHY_ID'=>array('value'=>$model->hIERARCHY->NAME, 'label'=>'Item'),	
		'ALIAS',
		'DESCRIPTION',
	...
	<p class="note">
		...
		<?php //echo $form->hiddenField($model,'ID',array('id'=>'ownerId','name'=>'ownerId')); ?>		
				...
				<?php 
			                    ...
			                    'url' => Yii::app()->createUrl("course/uploadDocument",array("id"=>$model->ID)),
			                    'model' => $fileModel,
								'attribute' => 'file',
