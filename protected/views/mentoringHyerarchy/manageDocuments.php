...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes'=>array(
		'ID',
		'NAME',
		'LEVEL_NUMBER'=>array('value'=>isset($model->lEVELNUMBER)?$model->lEVELNUMBER->NAME:'no asignado', 'label'=>'Jerarquia'),
	...
	<p class="text text-info">
		...
		<?php //echo $form->hiddenField($model,'ID',array('id'=>'ownerId','name'=>'ownerId')); ?>		
				...
				<?php 
			                    ...
			                    'url' => Yii::app()->createUrl("mentoringHyerarchy/uploadDocument",array("id"=>$model->ID)),
			                    'model' => $fileModel,
								'attribute' => 'file',
