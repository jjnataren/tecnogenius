...
class ExtGoogleAnalyticsCounter extends CWidget
{
    ...
    {
        $this->ga_email = 'jesus.nataren@gmail.com';//Yii::app()->params['ga_email'];
        $this->ga_password ='K4r3n621Qu3tz41198'; //Yii::app()->params['ga_password'];
        $this->ga_profile_id= '88276226'; //Yii::app()->params['ga_profile_id'];
    }
    ...
    public function GetTotalVisits()
    {
        ...
        echo '<span class="badge badge-info">' . $this->strTotalVisits . ': ' . $totalVisits . '</span>&nbsp;';
    }
    ...
    public function GetTodayVisits()
    {
        ...
        echo '<span class="badge badge-success">' . $this->strDayVisits . ': ' . $dayVisits . '</span>&nbsp;';
    }
