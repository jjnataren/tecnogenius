...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerYiiCss()
	{
		...
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/carousel.css');
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/google-code-prettify/prettify.css');
		//Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/offcanvas.css');
	}
	...
	protected function registerJS($position = CClientScript::POS_HEAD)
	{
		...
		$cs->registerScriptFile($this->getAssetsUrl().'/js/'.'offcanvas.js', $position);
		$cs->registerScriptFile($this->getAssetsUrl().'/css/google-code-prettify/'.'run_prettify.js', $position);
		$cs->registerScriptFile($this->getAssetsUrl().'/css/google-code-prettify/'.'prettify.js', $position);
	}
