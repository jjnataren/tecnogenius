...
class Document extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('COURSE_ID, DOCUMENT_TYPE, STATUS', 'numerical', 'integerOnly'=>true),
			array('NAME, DESCRIPTION, PATH, SIZE, THUMBNAIL, TYPE, DEL_TYPE, DEL_URL', 'length', 'max'=>300),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ID, COURSE_ID, NAME, DOCUMENT_TYPE, DESCRIPTION, PATH, SIZE, THUMBNAIL, TYPE, DEL_TYPE, DEL_URL, STATUS', 'safe', 'on'=>'search'),
		);
	}
	...
	public function  getStringType(){
	 ...
	 return isset($this->documents_type[$this->DOCUMENT_TYPE])? $this->documents_type[$this->DOCUMENT_TYPE] : '';
